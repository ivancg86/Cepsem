...
if (document.getElementById("myVideo") === undefined) {
  var endavant = function endavant() {
    vid.play();
  ...
  var validarPregunta = function validarPregunta() {
    var validar = false;
  ...
  var reanudar = function reanudar() {
    if (validarPregunta()) {
      CorrectePregunta();
    } else {
      ErrorPregunta();
  ...
  var ErrorPregunta = function ErrorPregunta() {
    setTimeout(function () {
  ...
  var CorrectePregunta = function CorrectePregunta() {
    setTimeout(function () {
      btnValidar.style.backgroundColor = "#D91480";
      btnValidar.innerHTML = "Validar";
      vid.play();
